...
class Migration(migrations.Migration):
    ...
    operations = [
        # 1. Update sp_create_sleep_record
        migrations.RunSQL(
            sql="""
            ...
            BEGIN
                ...
                START TRANSACTION;
                INSERT INTO sleepmanage_sleeprecord (user_id, date, sleep_time, wake_time, note, created_at)
                VALUES (p_user_id, p_date, p_sleep_time, p_wake_time, p_note, NOW());
                COMMIT;
        ...
        # 2. Update sp_update_sleep_record_safe
        migrations.RunSQL(
            sql="""
        ...
        # 3. Update sp_delete_sleep_record_safe
        migrations.RunSQL(
            sql="""
            DROP PROCEDURE IF EXISTS sp_delete_sleep_record_safe;
